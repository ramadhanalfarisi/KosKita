...
// create a component
class ModalTersimpan extends Component {
  state = {
    visible: false,
  };
  muncul() {
  ...
  simpan(key) {
    ...
    Alert.alert('Simpan Kost', 'Apakah anda ingin menyimpan kost ini ?', [
      {
        text: 'Iya',
        onPress: () => {
          fbs.database
      ...
      <Modal
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => this.simpan(this.props.detailkey)}>
            <Text
              style={{
                fontSize: 15,
                fontWeight: '700',
